...
<template>
	<div v-show="isShow" class="modal" id="modal-1" aria-hidden="true">
		<div class="modal__overlay" tabindex="-1" data-micromodal-close>
			<div class="modal__container w-2/3"> w-2/3" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
	...
	<div class="flex items-center w-full justify-between mb-2">
		<input name="customer" v-model="search" class="w-3/5 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
		<button @click="searchCustomers" type="button" data-micromodal-trigger="model-1" href='javascript:;'
